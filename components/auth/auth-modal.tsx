...
export function AuthModal({ isOpen, onClose, actionDescription }: AuthModalProps) {
  const { login } = useAuth();
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-2xl text-center">Save your report with CareAI</DialogTitle>
          <DialogDescription className="text-center pt-2">
            Create a free account to {actionDescription}, save and access your report anytime.
          </DialogDescription>
        </DialogHeader>
